    ...
    <link rel="preload" href="{{ asset('css/other.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ asset('css/other.css') }}"></noscript>
    <script>
        (function( w ){
	"use strict";
	// rel=preload support test
